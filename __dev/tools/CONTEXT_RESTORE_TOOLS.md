...
1. **Markdown** — беsparser `markdown_handler`; адресация делегируется. Оставить или обернуть в backend.
2. **Снять делегацию в `Reader`** — только если решим полностью унести py/md на reader-tree
   (сейчас не нужно: brace на reader-движке, py/md делегируют и согласованы по границам).
